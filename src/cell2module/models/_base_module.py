...
class RegressionBaseModule(PyroBaseModuleClass, AutoGuideMixinModule):
    def __init__(
        ...
        encoder_mode: Literal["single", "multiple", "single-multiple"] = "multiple",
        ...
        **kwargs,
        ...
        if "n_extra_categoricals" in kwargs.keys():
            n_cat_list = n_cat_list + list(kwargs["n_extra_categoricals"])

        encoder_instance = encoder_kwargs["encoder_instance"] if "encoder_instance" in encoder_kwargs else None
